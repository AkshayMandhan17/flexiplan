...
import { View, Text, Alert, StyleSheet, Dimensions, TextInput, KeyboardAvoidingView } from "react-native";
                  ...
                  <View style={styles.formContainer}>
                    ...
                    >
                      ...
                      <TouchableOpacity onPress={() => navigation.navigate("Signup")}>
                        <Text style={{color: 'rgb(255, 144, 70)',fontWeight: "bold",fontSize: scaleSize(16),}}>Sign Up</Text>
                      </TouchableOpacity>
                    </Animated.View>
                  </View>
                </View>
